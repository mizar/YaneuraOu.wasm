...
import YaneuraOu = require("./lib/yaneuraou.halfkpe9.noeval");
...
async function main(argv: string[]) {
  const wasmBinary = await fs.promises.readFile(path.join(__dirname, "./lib/yaneuraou.halfkpe9.noeval.wasm"));
