...
import YaneuraOu = require("./lib/yaneuraou.halfkpvm.noeval");
...
async function main(argv: string[]) {
  const wasmBinary = await fs.promises.readFile(path.join(__dirname, "./lib/yaneuraou.halfkpvm.noeval.wasm"));
