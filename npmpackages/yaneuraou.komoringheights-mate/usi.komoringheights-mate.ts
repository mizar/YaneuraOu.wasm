...
import YaneuraOu = require("./lib/yaneuraou.komoringheights-mate");
...
async function main(argv: string[]) {
  const wasmBinary = await fs.promises.readFile(path.join(__dirname, "./lib/yaneuraou.komoringheights-mate.wasm"));
