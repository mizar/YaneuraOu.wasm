...
if(isMainThread) {
  ...
  // number of worker generate : (number of logical cores) or (free memory size / 2.5Gbyte)
  const num_worker_gen = Math.max(Math.min(cpus().length, freemem() / 2684354560 | 0), 1);
