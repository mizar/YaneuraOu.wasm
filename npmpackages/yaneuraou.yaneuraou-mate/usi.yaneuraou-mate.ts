...
import YaneuraOu = require("./lib/yaneuraou.yaneuraou-mate");
...
async function main(argv: string[]) {
  const wasmBinary = await fs.promises.readFile(path.join(__dirname, "./lib/yaneuraou.yaneuraou-mate.wasm"));
